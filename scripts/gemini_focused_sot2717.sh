#!/usr/bin/env bash
# SOT-2717 — backend=gemini FOCUSED verification (official:false/dev; no submit, no champion touch).
...
export RAG_INVESTIGATOR_BACKEND=gemini
OUT="${FOCUSED_OUT:-artifacts/focused_gemini_sot2717.json}"
.venv/bin/python scripts/run_focused_gate.py \
  --label sot2717-idx8-52-gemini --issue SOT-2717 \
  --target "1,8,52,87,98" \
